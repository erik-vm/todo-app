...
export const useTodoStore = defineStore('todo', () => {
  ...
  const addTask = async (taskData: TodoTaskCreate) => {
    try {
  ...
  const updateTask = async (id: string, taskData: TodoTaskEdit) => {
    try {
  ...
  const addCategory = async (categoryData: Omit<TodoCategory, 'id' | 'syncDt'>) => {
    try {
  ...
  const addPriority = async (priorityData: Omit<TodoPriority, 'id' | 'syncDt'>) => {
    try {
